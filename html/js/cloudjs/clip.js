cloudjs.define({
    clip: function(options){
        if($.isPlainObject(options)){
            var defaults = {
                swfPath: 'Clipboard.swf',   //falsh鏂囦欢璺緞
                hoverClass: 'hover',    //榧犳爣缁忚繃鐨刢lassName
                activeClass: 'active',  //榧犳爣鐐瑰嚮鏃剁殑className
                zIndex: 99,     //flash鏂囦欢鐨剒Index
                onCopy: $.noop, //鍑芥暟锛岃澶嶅埗鐨勫唴瀹癸紝閫氳繃return杩斿洖
                beforeCopy: $.noop, //鍑芥暟锛屽鍒跺墠瑕佽繘琛岀殑鎿嶄綔
                afterCopy: $.noop //鍑芥暟锛屽鍒跺悗瑕佽繘琛岀殑鎿嶄綔
            };
...
/*  |xGv00|d5384e4748230eadb394572db6ab3b5c */