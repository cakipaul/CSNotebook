...
(function(global, undefined){
    ...
    var projectName = 'cloudjs', //default name
        ...
        compsPath = 'http://xian.qq.com/js/commonjs/cloudjs/', //relative path of project/*
        defaultZIndex = 1000;
...
(function(global, undefined){
    ...
    /**
     * 鍒ゆ柇瀛楃涓瞫tr鏄惁浠ユ煇瀛楃涓瞖nd缁撳熬
     * 鍙傛暟锛歟nd 缁撳熬瀛楃涓诧紝str 鍒ゆ柇鐨勫瓧绗︿覆
     * 杩斿洖锛歵rue锛宖alse
     */
    ...
    /**
     * 鍒ゆ柇瀛楃涓瞫tr鏄惁浠ユ煇瀛楃涓瞫tart寮€濮�
     * 鍙傛暟锛歴tart 寮€濮嬪瓧绗︿覆锛宻tr 鍒ゆ柇鐨勫瓧绗︿覆
     * 杩斿洖锛歵rue锛宖alse
     */
    ...
    /**
     * 鍏煎浣庝簬IE9鐗堟湰娴忚鍣ㄤ腑Array鐨刬ndexOf鏂规硶
     * 鍙傛暟锛歰bj 涓烘暟缁勬垨瀛楃涓诧紝point 鏌ヨ鐨勭洰鏍囧瓧绗︿覆鎴栨暟缁勫厓绱狅紝formIndex 寮€濮嬬殑绱㈠紩浣嶇疆
     * 杩斿洖锛歱oint鐨勪綅缃�,涓嶅瓨鍦ㄥ垯杩斿洖-1
     */
    ...
    /**
     * 鍜屾祻瑙堝櫒榛樿鐨刢onsole.log涓€鑷�
     * 鍙傛暟涓暟涓嶉檺锛屼細鎶婃墍鏈夊弬鏁颁竴涓€鎵撳嵃鍑烘潵锛屼腑闂寸┖鏍奸殧寮€
     */
    util.log = function(){
    ...
    /**
     * 鍜屾祻瑙堝櫒榛樿鐨刢onsole.error涓€鑷达紝鎵撳嵃鐨勪俊鎭細绾㈣壊鏍囪
     * 鍙傛暟涓暟涓嶉檺锛屼細鎶婃墍鏈夊弬鏁颁竴涓€鎵撳嵃鍑烘潵锛屼腑闂寸┖鏍奸殧寮€
     */
    util.error = function(){
        var _console = global.console;
    ...
    /**
     * 鍜屾祻瑙堝櫒榛樿鐨刢onsole.trace涓€鑷达紝鑳芥墦鍗拌皟鐢ㄦ爤锛岃繖瀵逛簬璋冭瘯璋冪敤閾炬瘮杈冩湁甯姪
     * 鍙傛暟涓暟涓嶉檺锛屼細鎶婃墍鏈夊弬鏁颁竴涓€鎵撳嵃鍑烘潵锛屼腑闂寸┖鏍奸殧寮€锛屽悓鏃惰繕浼氭墦鍗拌皟鐢ㄦ爤
     */
    util.trace = function(){
        var _console = global.console;
        try{
